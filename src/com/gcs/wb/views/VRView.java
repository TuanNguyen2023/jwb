 ...
 * @author vunguyent
 */
public class VRView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        chk_not_valid = new javax.swing.JCheckBox();
        btn_apply = new javax.swing.JButton();

        setClosable(true);
        setMaximizable(true);
        setResizable(true);
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.gcs.wb.WeighBridgeApp.class).getContext().getResourceMap(VRView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(com.gcs.wb.WeighBridgeApp.class).getContext().getActionMap(VRView.class, this);
        ...
        pnTAgentLayout.setHorizontalGroup(
            ...
            .addGroup(pnTAgentLayout.createSequentialGroup()
                ...
                .addGroup(pnTAgentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(spTAgent, javax.swing.GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE)
                    .addGroup(pnTAgentLayout.createSequentialGroup()
                        ...
                        .addGroup(pnTAgentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtAAbbr, javax.swing.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE)
                            .addComponent(txtAName, javax.swing.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE)))
        ...
        pnTAgentLayout.setVerticalGroup(
            pnTAgentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnTAgentLayout.createSequentialGroup()
                .addComponent(spTAgent, javax.swing.GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        chk_not_valid.setText(resourceMap.getString("chk_not_valid.text")); // NOI18N
        chk_not_valid.setName("chk_not_valid"); // NOI18N

        btn_apply.setAction(actionMap.get("apply")); // NOI18N
        btn_apply.setText(resourceMap.getString("btn_apply.text")); // NOI18N
        btn_apply.setName("btn_apply"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, lstVehicle, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), btn_apply, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
        ...
        pnVehicleLayout.setHorizontalGroup(
            ...
            .addGroup(pnVehicleLayout.createSequentialGroup()
                ...
                .addGroup(pnVehicleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(spVehicle, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 225, Short.MAX_VALUE)
                    .addGroup(pnVehicleLayout.createSequentialGroup()
                        .addComponent(lblLicPlate)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtLicPlate, javax.swing.GroupLayout.DEFAULT_SIZE, 186, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnVehicleLayout.createSequentialGroup()
                        .addGroup(pnVehicleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnVRemove)
                            .addComponent(chk_not_valid, javax.swing.GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(pnVehicleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(btn_apply, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(btnVSave, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );
        pnVehicleLayout.setVerticalGroup(
            pnVehicleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnVehicleLayout.createSequentialGroup()
                .addComponent(spVehicle, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void lstVehicleValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_lstVehicleValueChanged
        ...
        if (vehicle.getSoXe() != null) {
            ...
            if (vh != null) {
                try {
                    boolean l_valid = vh.getNotValid();
                    //if (l_valid == true){
    ...
    private javax.swing.JCheckBox chk_not_valid;
