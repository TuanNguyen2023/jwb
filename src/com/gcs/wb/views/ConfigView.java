...
//    }
    ...
    private DefaultComboBoxModel getPortModel() {
        return configController.getPortModel();
    }

    private DefaultComboBoxModel getSpeedModel() {
        return configController.getSpeedModel();
    }
    ...
    private boolean validateForm() {
        return configController.validateForm(txtDBHost, txtDBName, txtDBUsr, txtDBPwd, txtHost, txtPlant,
                lblDBHost, lblDBName, lblDBUsr, lblDBPwd, lblHost, lblSId, lblDClient,
                lblPort1, lblPort2, lblSpeed1, lblSpeed2, lblPlant, txfSNo, txfDClient,
                cbxPort1, cbxPort2, cbxSpeed1, cbxSpeed2);
    }

    private AppConfig objMapping() {
        return configController.objMapping(config, txtWBID, txtDBHost, txtDBName, txtDBUsr, txtDBPwd, txtHost, 
                txtRString, txfSNo, txfDClient, cbxPort1, cbxPort2, cbxSpeed1, cbxSpeed2, cbxDataBits1, cbxDataBits2,
                cbxStopBits1, cbxPControl1, chbMettler1, cbxStopBits2, cbxPControl2, chbMettler2, txtPlant);
    }

    private void objBinding() {
        configController.objBinding(config, txtWBID, txtDBHost, txtDBName, txtDBUsr, txtDBPwd, txtHost,
                txtRString, txfSNo, txfDClient, cbxPort1, cbxPort2, cbxSpeed1, cbxSpeed2, cbxDataBits1, cbxDataBits2, cbxStopBits1,
                cbxPControl1, chbMettler1, cbxStopBits2, cbxPControl2, chbMettler2, txtPlant);
    }
