 ...
 */
@Embeddable
public class PurOrderPK implements Serializable {
    ...
    public PurOrderPK(String mandt, String poNumber) {
        this.mandt = mandt;
    ...
    public boolean equals(Object object) {
        if (!(object instanceof PurOrderPK)) {
            return false;
        }
        PurOrderPK other = (PurOrderPK) object;
    ...
    public String toString() {
        return "com.gcs.wb.jpa.entity.PurOrderPK[mandt=" + mandt + ", poNumber=" + poNumber + "]";
    }
}
