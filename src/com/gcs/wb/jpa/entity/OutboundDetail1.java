...
@NamedQueries({
    @NamedQuery(name = "OutboundDetail.findByMandtDelivNumbItem",
    query = "SELECT o FROM OutboundDetail o WHERE"
    + " o.OutboundDetailPK.delivNumb LIKE :delivNumb"
    + " AND o.OutboundDetailPK.delivItem = :delivItem order by o.freeItem desc"),
    @NamedQuery(name = "OutboundDetail.findByMandtDelivNumb",
    query = "SELECT o FROM OutboundDetail o WHERE"
    + " o.OutboundDetailPK.delivNumb LIKE :delivNumb order by o.freeItem desc"),
    @NamedQuery(name = "OutboundDetail.findByWtId",
    query = "SELECT o FROM OutboundDetail o WHERE"
    + " o.wtId LIKE :wtId order by o.freeItem desc")
})
public class OutboundDetail1 implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        OutboundDetail1 that = (OutboundDetail1) o;
