...
public class OutboundDetailRepository {
    ...
    public List<OutboundDetail> findByDeliveryOrderNo(String mandt, String deliv_numb) {
    ...
    public List<OutboundDetail> findByDeliveryOrderNoAndDeliveryOrderItem(String mandt, String deliv_numb, String item) {
        List<OutboundDetail> result = new ArrayList<OutboundDetail>();
        try {
    ...
    public List<OutboundDetail> findByWtId(String client, String wt_id) {
        List<OutboundDetail> result = new ArrayList<OutboundDetail>();
        try {
