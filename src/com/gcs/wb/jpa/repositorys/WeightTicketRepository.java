...
public class WeightTicketRepository {
    ...
    public List<WeightTicket> findListWeightTicket(String month, String year, String tagent, String matnr, List<Character> modes, StatusEnum status) {
        List<WeightTicket> list = new ArrayList<>();
    ...
    public List<WeightTicket> findListWeightTicket(Date from, Date to,
            ...
            String material, StatusEnum status, ModeEnum mode) {
        List<WeightTicket> list = new ArrayList<>();
